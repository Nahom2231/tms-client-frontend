...
describe('EnrollmentService', ()=> {
   ...
   it('getAll() issues GET /api/enrollments and maps the response ', async ()=> {
    ...
    req.flush([
        ...
        { id: 2, studentId: 12, studentName: 'Kebede', courseId: 102, courseName: 'Data Structures',
             status: 'Approved', enrolledAt: '2026-08-12T10:05:00Z' },
    ]);

    it('approved(id) issues PUT /api/enrollments/{id}/approve', async ()=> {
